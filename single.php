...
<img src="<?php echo BASE_URL . '/assets/images/' . $post['image']; ?>" style="width:100%;">
...
$previous= $conn->query("SELECT * from pages where id<$id order by id DESC limit 5");

// look through query
       while($pages = $previous->fetch()){
         echo '<h2><a href="'.$pages['title'].'">'.$pages['title'].'</a></h2>';
