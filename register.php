...
<div class="body-section">
 ...
 <div class="form-input">
        <label>Email</label>
        <input type="email" name="email"  value="<?php echo $email; ?>" class="text-input" placeholder="Email Address">
      </div>
 <div class="form-input">
 ...
 <div class="form-input">
      ...
      <div>
        <button type="submit" name="register-btn" class="btn-submit">Register</button>
      </div>
...
Or <a href="<?php echo BASE_URL . 'login.php' ?>">Login</a>  | <a href="<?php echo BASE_URL . '' ?>">Back to Home</a></span>
</div>
