    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
           ...
           <li class="user-body">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo ADMIN_URL . '/index.php?logout' ?>" class="btn btn-default btn-flat"><i class="fa fa-sign-out fa-fw"></i><?php echo $signout; ?></a>
                </div>
              </li>
            </ul>
          </li>
          ...
          <li>
            <a href="<?php echo ADMIN_URL . '/index.php' ?>" title="<?php echo $site; ?> <?php echo $view; ?>" target="_blank"><i class="fa fa-home"></i></a>
          </li>
        </ul>
      </div>
    </nav>
...
<li class="treeview active">
          <a href="<?php echo ADMIN_URL . '/posts/index.php' ?>"><i class="fa fa-thumb-tack"></i> 
          <span> <?php echo $newspost;?> </span>
          ...
          <ul class="treeview-menu">
             ...
             <li><a href="<?php echo ADMIN_URL . '/posts/index.php' ?>"><?php echo $posts_all;?></a></li>
            <li><a href="<?php echo ADMIN_URL . '/posts/create.php' ?>"><?php echo $add_new;?></a></li>                        
             <li><a href="<?php echo ADMIN_URL . '/topics/index.php' ?>"><?php echo $topic_all;?></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
             ...
             <li><a href="<?php echo ADMIN_URL . '/posts/create.php' ?>"><?php echo $library;?></a></li>                        
        ...
        <span><?php echo $comments;?></span></a>
         ...
         <li class="treeview">
          <a href="<?php echo ADMIN_URL . '/pages/index.php' ?>"><i class="fa fa-clone"></i> 
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo ADMIN_URL . '/pages/index.php' ?>"><?php echo $pages_all;?></a></li>
            <li><a href="<?php echo ADMIN_URL . '/pages/create.php' ?>"><?php echo $add_new;?></a></li>
          </ul>
        </li>
       ...
       <li class="treeview">
          <a href="<?php echo ADMIN_URL . '/users/index.php' ?>"><i class="fa fa-user"></i> 
          ...
          <ul class="treeview-menu">
             ...
             <li><a href="<?php echo ADMIN_URL . '/users/index.php' ?>"><?php echo $users_all;?></a></li>
            <li><a href="<?php echo ADMIN_URL . '/users/create.php' ?>"><?php echo $add_new;?></a></li>   
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo ADMIN_URL . '/themes.php' ?>"><?php echo $theme;?></a></li>
            <li><a href="<?php echo ADMIN_URL . '/themes-install.php' ?>"><?php echo $add_new;?></a></li>
          </ul>
        </li>
